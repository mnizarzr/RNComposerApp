...
import {View, StyleSheet, Text, TouchableOpacity,ActivityIndicator,Image, Dimensions, FlatList, ScrollView} from 'react-native'
            ...
            <View style={styles.container}>
                {
                    this.state.loading == true ? 
                        <View style={{flex: 1}}>
                            <ActivityIndicator size={36} style={{alignSelf: 'center'}} color={'#666'} ></ActivityIndicator>
                        </View>
                        :
